# Frontend Capability: Dashboard Shell 與服務狀態首頁

## ADDED Requirements

### Requirement: Collapsible sidebar

Frontend SHALL provide a left sidebar that can be toggled between expanded and collapsed states using a menu icon button.
